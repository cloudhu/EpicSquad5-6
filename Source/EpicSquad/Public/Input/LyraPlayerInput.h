...
class EPICSQUAD_API ULyraPlayerInput : public UEnhancedPlayerInput
{
	GENERATED_BODY()
...
protected:
	...
	void ProcessInputEventForLatencyMarker(const FInputKeyEventArgs& Params) const;
	void BindToLatencyMarkerSettingChange();
	void UnbindLatencyMarkerSettingChangeListener() const;
