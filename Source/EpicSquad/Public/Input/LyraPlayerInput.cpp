...
void ULyraPlayerInput::ProcessInputEventForLatencyMarker(const FInputKeyEventArgs& Params) const
{
...
void ULyraPlayerInput::UnbindLatencyMarkerSettingChangeListener() const
{
	ULyraSettingsLocal* Settings = ULyraSettingsLocal::Get();
	if (!Settings)
	{
