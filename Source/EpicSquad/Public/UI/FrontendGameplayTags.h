...
namespace FrontendGameplayTags
{
	...
	EPICSQUAD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Widget_HUD);
	EPICSQUAD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Widget_PauseMenu);
	EPICSQUAD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Widget_Inventory);
	EPICSQUAD_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Widget_ItemActionMenu);
