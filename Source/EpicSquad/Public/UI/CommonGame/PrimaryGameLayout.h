...
class EPICSQUAD_API UPrimaryGameLayout : public UCommonUserWidget
{
	GENERATED_BODY()
...
public:
	...
	{
		return PushWidgetToLayerStackAsync<ActivatableWidgetT>(
			LayerName, bSuspendInputUntilComplete, ActivatableWidgetClass,
