...
#include "ActivatableWidget_ViewModel.generated.h"
 ...
 */
UCLASS()
class EPICSQUAD_API UActivatableWidget_ViewModel : public ULyraActivatableWidget, public ICombatActorAwareInterface
{
	GENERATED_BODY()
public:
	UActivatableWidget_ViewModel(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
